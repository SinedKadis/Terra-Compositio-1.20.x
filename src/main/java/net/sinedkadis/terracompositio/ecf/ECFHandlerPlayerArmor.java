...
public class ECFHandlerPlayerArmor implements IECFHandler {
    ...
    public String toString() {
        ...
        {
            Optional<IECFHandler> capability = Optional.ofNullable(icfeHandler.getCapability(TCCapabilities.ECF_HANDLER_ITEM));
