...
public class TCRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    private static void buildApples(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildFloatingRedstone(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildCFJ(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildCedarBlocks(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildTechnetiumOreProcessing(Consumer<FinishedRecipe> pWriter) {
        int base1 = 128;
    ...
    private static void buildPathPointers(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildWrenchAxe(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildMisc(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildDesorbers(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildGoldMaterials(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildInfusedIronMaterials(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildCedarArmor(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildTechnetiumMaterials(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildCopperMaterials(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildSpecial(Consumer<FinishedRecipe> pWriter) {
    ...
    private static void buildMatterInfuserBlocks(Consumer<FinishedRecipe> pWriter) {
    ...
    protected static void cookSmelting(Consumer<FinishedRecipe> pFinishedRecipeConsumer, List<ItemLike> pIngredients, RecipeCategory pCategory, ItemLike pResult, float pExperience, int pCookingTime, String pGroup) {
    ...
    private void buildCompat(Consumer<FinishedRecipe> pWriter) {
        if (ModList.get().isLoaded("create")) {
            TerraCompositio.createCompat.getDataGen().buildRecipes(this, pWriter);
        }
    }

    private void buildTechnetiumArmor(Consumer<FinishedRecipe> pWriter) {
