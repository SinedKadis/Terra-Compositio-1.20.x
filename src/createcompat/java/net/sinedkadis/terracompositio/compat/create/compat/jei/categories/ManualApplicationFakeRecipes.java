...
public class ManualApplicationFakeRecipes {
    ...
    public static List<RecipeHolder<ItemApplicationRecipe>> createRecipes() {
        List<RecipeHolder<ItemApplicationRecipe>> recipes = new ArrayList<>();

        recipes.add(new RecipeHolder<>(TerraCompositio.modLoc("flow_infuser"),new ItemApplicationRecipe.Builder<>(ManualApplicationWIthToolRecipe::new,
                TerraCompositio.modLoc("flow_infuser"))
        ...
        recipes.add(new RecipeHolder<>(TerraCompositio.modLoc("cedar_casing"),
                new ItemApplicationRecipe.Builder<>(ManualApplicationRecipe::new,
                        TerraCompositio.modLoc("cedar_casing"))
                .require(TCBlocks.FLOW_CEDAR_LOG.get())
                .require(Ingredient.of(goldRods.stream()))
                .output(TCBlocks.FLOW_CEDAR_CASING.get())
                .build()));
        recipes.add(new RecipeHolder<>(TerraCompositio.modLoc("cedar_tank_1"),
                new ItemApplicationRecipe.Builder<>(ManualApplicationRecipe::new,
                        TerraCompositio.modLoc("cedar_tank_1"))
                ...
                .build()));
        recipes.add(new RecipeHolder<>(TerraCompositio.modLoc("cedar_tank_2"),
                new ItemApplicationRecipe.Builder<>(ManualApplicationRecipe::new,
